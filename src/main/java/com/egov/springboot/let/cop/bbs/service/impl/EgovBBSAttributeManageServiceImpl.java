package com.egov.springboot.let.cop.bbs.service.impl;
...
import com.egov.springboot.let.cop.com.service.BoardUseInf;
import com.egov.springboot.let.cop.com.service.EgovUserInfManageService;
import com.egov.springboot.let.cop.com.service.UserInfVO;
import com.egov.springboot.let.cop.com.service.impl.BBSUseInfoManageDAO;
...
public class EgovBBSAttributeManageServiceImpl extends EgovAbstractServiceImpl implements EgovBBSAttributeManageService {
     ...
     * 등록된 게시판 속성정보를 삭제한다.
     *
     * @see com.egov.springboot.let.cop.bbs.service.EgovBBSAttributeManageService#deleteBBSMasterInf(com.egov.springboot.let.cop.bbs.service.BoardMaster)
     */
     ...
     * 신규 게시판 속성정보를 생성한다.
     *
     * @see com.egov.springboot.let.cop.bbs.service.EgovBBSAttributeManageService#insertBBSMastetInf(com.egov.springboot.let.cop.bbs.service.BoardMaster)
     */
     ...
     *
     * @see com.egov.springboot.let.cop.bbs.service.EgovBBSAttributeManageService#selectAllBBSMasteInf(com.egov.springboot.let.cop.bbs.service.BoardMasterVO)
     */
     ...
     *
     * @see com.egov.springboot.let.cop.bbs.service.EgovBBSAttributeManageService#selectBBSMasterInf(com.egov.springboot.let.cop.bbs.service.BoardMasterVO)
     */
     ...
     * 게시판 속성 정보의 목록을 조회 한다.
     *
     * @see com.egov.springboot.let.cop.bbs.service.EgovBBSAttributeManageService#selectBBSMasterInfs(com.egov.springboot.let.cop.bbs.service.BoardMasterVO)
     */
     ...
     * 게시판 속성정보를 수정한다.
     *
     * @see com.egov.springboot.let.cop.bbs.service.EgovBBSAttributeManageService#updateBBSMasterInf(com.egov.springboot.let.cop.bbs.service.BoardMaster)
     */
     ...
     * 템플릿의 유효여부를 점검한다.
     *
     * @see com.egov.springboot.let.cop.bbs.service.EgovBBSAttributeManageService#validateTemplate(com.egov.springboot.let.cop.bbs.service.BoardMasterVO)
     */
